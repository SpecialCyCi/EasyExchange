...
module Entities
  ...
  class Product < Grape::Entity
    expose :id, :name, :description, :durability, :price, :product_options, :created_at, :updated_at, :latitude, :longitude, :contacter, :contact, :origin_price, :publishing_company, :writer, :exchangeable, :want_exchange
    expose :school do |model, opts|
      Entities::School.represent model.school
    end
