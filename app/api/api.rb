  ...
  class Root < Grape::API
    ...
    resource :product do
      ...
      post ":id/update" do
        ...
        new_params = ActionController::Parameters.new(params).require(:product).permit(:name, :description, :photos_attributes, :durability, :price, :product_options_attributes, :origin_price, :publishing_company, :writer )
